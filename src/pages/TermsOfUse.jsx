  ...
  return (
    <div className="terms-of-use">
      ...
      <form>
        ...
        <h4>Last update: July 25th, 2020</h4>

        <p>
        These Terms of Service govern the use of the services offered by RemoteReq Inc. (the “Company”) at the Company’s website (remotereq.com the “Site”) or
        mobile applications. Such services, the Site and mobile applications together are hereinafter collectively
        referred to as the “Service.” Your use of the Service constitutes your acceptance of and agreement to all of
        ...
        “Agreement.”  All use of the Service is expressly conditioned upon your assent to all terms and conditions
        of this Agreement.  If you are accessing the services on behalf of your employer or any other entity you
        represent in relation to this Agreement, you represent and warrant that you have the authority to agree
        to these terms on its behalf and the right to bind such employer or other entity thereto.
        </p>

        <br/>

        <p>
        These Terms of Service include, but are not limited to, the following:
        </p>
        ...
        <ul>
          ...
          <li>Your agreement that, for a period of one year following the completion of an Assignment, a Client may not solicit the services of a Provider who has performed such Assignment for such Client other than by means of the Service.</li>
        ...
        <h4>Service Connects Providers and Clients</h4>
        <p>
          The Service is a communications platform which enables the connection between (a) individuals and/or
          businesses (“Providers” or “Job seekers”) seeking to perform event and/or other work services
        ...
        <h4>Service Only Provides a Venue</h4>

        <p>
          The Service is a platform for enabling connections between Users for the fulfillment of Assignments,
          but Company is not responsible for the performance of Users, nor does it have control over the quality,
          timing, legality, failure to provide, or any other aspect whatsoever of Assignments, nor of the integrity,
          responsibility or any of the actions or omissions whatsoever of any Users. Company does not have control
          over the quality, timing or legality of Assignments delivered by Providers.
          Company makes no representations about the suitability, reliability, timeliness, or accuracy of the
          Assignments requested and provided by Users identified through the Service whether in public, private,
        ...
        <p>
          Clients and Providers may be subject to an extensive vetting process before they can register and
          during their use of the Service, including but not limited to a verification of identity and a
          comprehensive criminal background check, at the Country, State and local level, using third party
          services as appropriate. Users hereby give consent to Company to conduct background checks as often as
          required in compliance with federal and state laws and the Fair Credit Reporting Act.
        </p>

        <br/>

        <p>
          Although Company may perform background checks of Users, as outlined above,
          Company cannot confirm that each User is who they claim to be and therefore,
          Company cannot and does not assume any responsibility for the accuracy or
          reliability identity or background check information or any information provided through the Service.
        </p>
        ...
        <p>
          ...
          your personal safety and property, just as you would when interacting with other persons whom
          you don’t know. NEITHER COMPANY NOR ITS AFFILIATES OR LICENSORS IS RESPONSIBLE FOR THE CONDUCT,
          WHETHER ONLINE OR OFFLINE, OF ANY — USER OF THE SERVICE AND YOU HEREBY RELEASE THE COMPANY AND ITS
          AFFILIATES OR LICENSORS FROM ANY LIABILITY RELATED THERETO. COMPANY AND ITS AFFILIATES AND LICENSORS
          WILL NOT BE LIABLE FOR ANY CLAIM, INJURY OR DAMAGE ARISING IN CONNECTION WITH YOUR —
          USE OF THE SERVICE.
        </p>
        ...
        <p>
          Users of the Service contract for Assignments directly with other Users. Company will not be a party to any contracts for Assignments or services.
        ...
        <p>
          Clients will be responsible for paying the invoice for each Assignment (the “Invoice”), which will include the pricing terms of the Assignment agreed with and provided by a Provider (“Assignment Payment”), any out of pocket expenses agreed with and submitted by a Provider in connection with the Assignment, any tip or gratuity, if applicable, and the fee the Company assesses for the Service, based on the Assignment Payment amount.  Client agrees to pay all Invoices by the date and according to the terms set forth therein.  Any late payment may be automatically charged to the Client’s account and shall bear interest at a rate of 1.5% per month.
        </p>

        <br/>

        <p>
        Providers may be required to register with the PSP, agree to Terms of Service of the PSP and go through a vetting process at the request of the PSP to set up their account with the PSP. Terms of Service between Providers and the PSP retained by Company are available here (the “PSP Agreement”). By accepting these Terms of Use, each Provider agrees that they have downloaded or printed, and reviewed and agreed to the PSP Agreement. Please note that the Company is not a party to the PSP Agreement and that you, the PSP and any other parties listed in the PSP Agreement (currently, Stripe) are the parties to the PSP Agreement and that the Company has no obligations or liability to any Provider under the PSP Agreement.  Provider agrees that Company is not responsible for payment, and that all payments are based on hours reported by the Client.  Company will not be responsible for any disputes or discrepancies.  Client agrees that Company shall have no obligation to process any refund or reimbursement after a payment has been made to a Provider and that Company shall not be responsible for adjustments to payments or hours worked for which Client fails to provide timely written notice to Company.
        </p>

        <br/>

        <p>
          Within 24 hours after Client receives confirmation through the Service or via email that an Assignment has been completed, Client authorizes Company to provide Client’s payment details to the PSP for processing of Assignment Payment, out of pocket expenses owed to Provider, any tip or gratuity, if applicable, and any fees owed to Company for the use of the Service. You may be charged a cancellation fee of half of the cost of the assignment through the PSP if you book an Assignment, but cancel with less than 24 hours notice or substantially modify it before it is completed, as set forth in the Assignment pricing terms.
        ...
        <p>
          Assignment Payment and fees must be paid through the Service.
        ...
        <p>
          The Service is only a venue for connecting Users. Because Company is not involved in the actual contact between Users or in the completion of the Assignment, in the event that you have a dispute with one or more Users, you hereby release Company (and our officers, directors, agents, investors, subsidiaries, and employees) from any and all claims, demands, liability or damages (actual or consequential) of every kind and nature, known and unknown, suspected and unsuspected, disclosed and undisclosed, arising out of or in any way connected with such disputes.  User shall and hereby does waive California Civil Code Section 1542, or any similar law of any jurisdiction, which says in substance: “A general release does not extend to claims which the creditor does not know or suspect to exist in his or her favor at the time of executing the release, which, if known by him or her must have materially affected his or her settlement with the debtor.”
          Company expressly disclaims any liability that may arise between Users of the Service.
        </p>
        ...
        <ul>
          ...
          <li>Use the Service for any purpose, including, but not limited to posting or completing an Assignment, in violation of local, state, national, or international law.</li>
          ...
          <li>Advertise or offer to sell any goods or services for any commercial purpose through the Service that are not relevant to the services offered through the Service.</li>
          ...
          <li>Post the same Assignment repeatedly (“Spamming”). Spamming is strictly prohibited.</li>
        ...
        <p>Company may terminate or suspend your right to use the Service at any time for any or no reason by providing you with written or email notice of such termination, and termination will be effective immediately upon delivery of such notice.</p>

        <p>Without limitation, Company may terminate or suspend your right to use the Service if you breach any term of this Agreement or any policy of Company posted through the Service from time to time, or if Company otherwise finds that you have engaged in inappropriate and/or offensive behavior. If Company terminates or suspends your right to use the Service for any of these reasons, you will not be entitled to any refund of unused balance in your account. If Company terminates or suspends your account for any reason, you are prohibited from registering and creating a new account under your name, a fake or borrowed name, or the name of any third party, even if you may be acting on behalf of the third party. In addition to terminating or suspending your account, Company reserves the right to take appropriate legal action, including without limitation pursuing civil, criminal, and injunctive redress.</p>

        <br/>

        <p>Even after your right to use the Service is terminated or suspended, this Agreement will remain enforceable against you.</p>

        <br/>

        <p>You may terminate this Agreement at any time by ceasing all use of the Service. All sections which by their nature should survive the expiration or termination of this Agreement shall continue in full force and effect subsequent to and notwithstanding the expiration or termination of this Agreement.</p>

        <br/>

        <h4>Account, Password, Security and Mobile Phone Use</h4>
        ...
        <ul>
          ...
          <li>Use, and permit to be used, such User’s name and identity in connection with the Service.</li>
        </ul>

        <br/>

        <p>Each User understands that certain information including without limitation, biographic information, employment history, education, salary information, a personal photograph or likeness, and other personally identifying information (“Profile Information”) may be used, published or otherwise disclosed to third parties in connection with the Service and hereby waives all rights and releases the Company from, and shall neither sue nor bring any proceeding against any such parties for, any claim or cause of action, whether now known or unknown, for defamation, invasion of right to privacy, publicity or personality or any similar matter, or based upon or relating to the use and exploitation of such Profile Information including User’s identity, likeness or voice in connection with the Service.</p>
        ...
        <p>
          As part of the functionality of the Service, you may link your account with online accounts you may
          ...
          (ii) allowing Company to access your Third Party Account, as is permitted under the applicable terms
          and conditions that govern your use of each Third Party Account. You represent that you are entitled
          to disclose your Third Party Account login information to Company and/or grant Company access to your
          Third Party Account (including, but not limited to, for use for the purposes described herein),
          without breach by you of any of the terms and conditions that govern your use of the applicable
          Third Party Account and without obligating Company to pay any fees or making Company subject to any
          usage limitations imposed by such third party service providers. By granting Company access to any
          Third Party Accounts, you understand that (i) Company may access, make available and store
          (if applicable) any content that you have provided to and stored in your Third Party Account
          (the “SNS Content”) so that it is available on and through the Service via your account,
          including without limitation any friend lists, and (ii) Company may submit and receive additional
          information to your Third Party Account to the extent you are notified when you link your account
          with the Third Party Account. Unless otherwise specified in these Terms of Service, all SNS Content,
          if any, shall be considered to be User Generated Content for all purposes of these Terms of Service.
          Depending on the Third Party Accounts you choose and subject to the privacy settings that you have
          set in such Third Party Accounts, personally identifiable information that you post to your
          Third Party Accounts may be available on and through your account on the Service.
          Please note that if a Third Party Account or associated service becomes unavailable or
          Company’s access to such Third Party Account is terminated by the third party service provider,
          then SNS Content may no longer be available on and through the Service. You will have the ability
          to disable the connection between your account on the Service and your
          ...
          Company makes no effort to review any SNS Content for any purpose, including but not limited to,
          for accuracy, legality or non-infringement, and Company is not responsible for any SNS Content.
        ...
        <p>The service marks and trademarks of Company, including without limitation Company and the Company logos are service marks owned by Company. Any other trademarks, service marks, logos and/or trade names appearing via the Service are the property of their respective owners. You may not copy or use any of these marks, logos or trade names without the express prior written consent of the owner.</p>
        ...
        <p>THE SERVICE IS PROVIDED ON AN “AS IS” BASIS WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT. COMPANY MAKES NO WARRANTIES OR REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE CONTENT PROVIDED THROUGH THE SERVICE OR THE CONTENT OF ANY SITES LINKED TO THE SERVICE AND ASSUMES NO LIABILITY OR RESPONSIBILITY FOR ANY (I) ERRORS, MISTAKES, OR INACCURACIES OF CONTENT, (II) PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF THE SERVICE, (III) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION STORED THEREIN. COMPANY DOES NOT WARRANT, ENDORSE, GUARANTEE OR ASSUME RESPONSIBILITY FOR ANY SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE SERVICE OR ANY HYPERLINKED WEBSITE OR FEATURED IN ANY BANNER OR OTHER ADVERTISING AND COMPANY WILL NOT BE A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES, OTHER THAN AS PROVIDED HEREIN. AS WITH THE PURCHASE OF A PRODUCT OR SERVICE THROUGH ANY MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD USE YOUR BEST JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE.</p>

        <br/>

        <p>WITHOUT LIMITING THE FOREGOING, NEITHER COMPANY NOR ITS AFFILIATES OR LICENSORS WARRANT THAT ACCESS TO THE SERVICE WILL BE UNINTERRUPTED OR THAT THE SERVICE WILL BE ERROR-FREE; NOR DO THEY MAKE ANY WARRANTY AS TO THE RESULTS THAT MAY BE OBTAINED FROM THE OF THE SERVICE, OR AS TO THE TIMELINESS, ACCURACY, RELIABILITY, COMPLETENESS OR CONTENT OF ANY ASSIGNMENT OR SERVICE, INFORMATION OR MATERIALS PROVIDED THROUGH OR IN CONNECTION WITH THE USE OF THE SERVICE.</p>

        <br/>

        <p>NEITHER COMPANY NOR ITS AFFILIATES OR LICENSORS IS RESPONSIBLE FOR THE CONDUCT, WHETHER ONLINE OR OFFLINE, OF ANY USER.</p>

        <br/>

        <p>NEITHER COMPANY NOR ITS AFFILIATES OR LICENSORS WARRANT THAT THE SERVICE IS FREE FROM VIRUSES, WORMS, TROJAN HORSES, OR OTHER HARMFUL COMPONENTS.</p>

        <br/>

        <p>COMPANY AND ITS AFFILIATES AND LICENSORS CANNOT AND DO NOT GUARANTEE THAT ANY PERSONAL INFORMATION SUPPLIED BY YOU WILL NOT BE MISAPPROPRIATED, INTERCEPTED, DELETED, DESTROYED OR USED BY OTHERS.</p>

        <br/>

        <p>IN ADDITION, NOTWITHSTANDING ANY FEATURE A CLIENT MAY — USE TO EXPEDITE JOBBLE SELECTION, EACH CLIENT IS RESPONSIBLE FOR SELECTING ITS PROVIDER AND NEGOTIATING TERMS OF WORK AND COMPANY DOES NOT WARRANT ANY GOODS OR SERVICES PURCHASED BY A CLIENT AND DOES NOT RECOMMEND ANY PARTICULAR PROVIDER. COMPANY DOES NOT PROVIDE ANY WARRANTIES OR GUARANTEES REGARDING ANY PROVIDER’S PROFESSIONAL ACCREDITATION, REGISTRATION OR LICENSE.</p>
        ...
        <p>UNDER NO CIRCUMSTANCES WILL COMPANY, ITS AFFILIATES, ITS LICENSORS, OR ANY OF SUCH PARTIES’ AGENTS, EMPLOYEES, OFFICERS, DIRECTORS, CORPORATE PARTNERS, OR PARTICIPANTS BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL, CONSEQUENTIAL, SPECIAL OR EXEMPLARY DAMAGES ARISING IN CONNECTION WITH YOUR USE OF OR INABILITY TO USE THE SERVICES, EVEN IF ADVISED OF THE POSSIBILITY OF THE SAME. SOME STATES DO NOT ALLOW THE EXCLUSION OR LIMITATION OF INCIDENTAL OR CONSEQUENTIAL DAMAGES, SO THE ABOVE LIMITATIONS MAY NOT APPLY TO YOU.</p>

        <br/>

        <p>COMPANY DOES NOT ACCEPT AND EXPRESSLY DISCLAIMS ANY LIABILITY WITH RESPECT TO THE QUALITY OR FITNESS OF ANY WORK PERFORMED VIA THE SERVICE.</p>

        <br/>

        <p>IN NO EVENT WILL COMPANY’S AGGREGATE LIABILITY, WHETHER ARISING IN CONTRACT, TORT, STRICT LIABILITY OR OTHERWISE, EXCEED THE TOTAL FEES PAID BY YOU TO COMPANY DURING THE SIX (6) MONTHS PRIOR TO THE TIME SUCH CLAIM AROSE.</p>
        ...
        <p>BINDING ARBITRATION. If you and Company are unable to resolve a Dispute through informal negotiations, all claims arising from use of the Service (except those Disputes expressly excluded below) finally and exclusively resolved by binding arbitration. Any election to arbitrate by one party will be final and binding on the other. YOU UNDERSTAND THAT IF EITHER PARTY ELECTS TO ARBITRATE, NEITHER PARTY WILL HAVE THE RIGHT TO SUE IN COURT OR HAVE A JURY TRIAL. The arbitration will be commenced and conducted under the Commercial Arbitration Rules (the “AAA Rules”) of the American Arbitration Association (“AAA”) and, where appropriate, the AAA’s Supplementary Procedures for Consumer Related Disputes (“AAA Consumer Rules”), both of which are available at the AAA website<a href="http://www.adr.org" > www.adr.org</a>. Your arbitration fees and your share of arbitrator compensation will be governed by the AAA Rules (and, where appropriate, limited by the AAA Consumer Rules). The arbitration may be conducted in person, through the submission of documents, by phone or online. The arbitrator will make a decision in writing, but need not provide a statement of reasons unless requested by a party. The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except as otherwise provided in this Agreement, you and Company may litigate in court to compel arbitration, stay proceeding pending arbitration, or to confirm, modify, vacate or enter judgment on the award entered by the arbitrator.</p>

        <br/>

        <p>EXCEPTIONS TO ALTERNATIVE DISPUTE RESOLUTION. Each party retains the right to bring an individual action in small claims court or to seek injunctive or other equitable relief on an individual basis in a federal or state court in Boston, Massachusetts with respect to any dispute related to the actual or threatened infringement, misappropriation or violation of a party’s intellectual property or proprietary rights.</p>

        <br/>

        <p>WAIVER OF RIGHT TO BE A PLAINTIFF OR CLASS MEMBER IN A PURPORTED CLASS ACTION OR REPRESENTATIVE PROCEEDING. You and Company agree that any arbitration will be limited to the Dispute between Company and you individually. YOU ACKNOWLEDGE AND AGREE THAT YOU AND COMPANY ARE EACH WAIVING THE RIGHT TO PARTICIPATE AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS ACTION OR REPRESENTATIVE PROCEEDING. Further, unless both you and Company otherwise agree, the arbitrator may not consolidate more than one person’s claims, and may not otherwise preside over any form of any class or representative proceeding. If this specific paragraph is held unenforceable, then the entirety of this “Dispute Resolution” Section will be deemed null and void.</p>

        <br/>

        <p>LOCATION OF ARBITRATION. Arbitration will take place in Austin, Texas. You and Company agree that for any Dispute not subject to arbitration (other than claims proceeding in any small claims court), or where no election to arbitrate has been made, the Texas state and Federal courts located in Austin, Texas have exclusive jurisdiction and you and Company agree to submit to the personal jurisdiction of such courts.</p>

        <br/>

        <h4>Governing Law</h4>

        <p>You and Company agree that, other than as set forth under the subsection entitled “Waiver Of Right To Be A Plaintiff Or Class Member In A Purported Class Action Or Representative Proceeding” above, if any portion of the section entitled “Dispute Resolution” is found illegal or unenforceable, that portion will be severed and the remainder of the section will be given full force and effect. Notwithstanding the foregoing, if the subsection entitled “Exceptions to Alternative Dispute Resolution” above is found to be illegal or unenforceable, neither you nor Company will elect to arbitrate any Dispute falling within that portion of that subsection that is found to be illegal or unenforceable and such Dispute will be decided by a court of competent jurisdiction within Austin, Texas, and you and Company agree to submit to the personal jurisdiction of that court.</p>

        <br/>

        <p>Except as expressly provided otherwise, this Agreement will be is governed by, and will be construed under, the laws of the state of Texas, without regard to choice of law principles.</p>
        ...
        <p>Failure by Company to enforce any provision(s) of this Agreement will not be construed as a waiver of any provision or right. The provisions of this Agreement will be governed by and construed in accordance with the laws of the Commonwealth of Massachusetts, without regard to its conflict of laws rules. This Agreement (including these Terms of Service, the Provider Terms and the Privacy Policy) constitutes the entire agreement between you and Company with respect to its subject matter. If any provision of this Agreement is found to be invalid or unenforceable, the remaining provisions will be enforced to the fullest extent possible, and the remaining provisions will remain in full force and effect. This Agreement will inure to the benefit of Company, its successors and assigns.</p>
        ...
        <p>I HEREBY ACKNOWLEDGE THAT I HAVE READ AND UNDERSTAND THE FOREGOING TERMS OF SERVICE AND PRIVACY POLICY AND AGREE THAT MY USE OF THE SERVICE IS AN ACKNOWLEDGMENT OF MY AGREEMENT TO BE BOUND BY THE TERMS AND CONDITIONS OF THIS AGREEMENT.</p>
