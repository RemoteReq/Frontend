  ...
  return (
    <div className="privacy-policy">
      <form>
        ...
        <h4 className="underline">What this Privacy Policy Covers</h4>
        ...
        <h4 className="underline">Categories of Personal Data We Collect</h4>

        <p className="smaller-paragraph">
          The chart in this section details the categories of Personal Data that we collect:
        </p>
        ...
        <h4 className="underline">Sources of Personal Data</h4>
        <p className="smaller-paragraph">
        ...
        <h4 className="underline">Information about Interest-Based Advertisements</h4>
        <p className="smaller-paragraph">
        ...
        <h4 className="underline">How We Use Your Personal Data</h4>
        <p>
        ...
        <h4 className="underline">How We Share Your Personal Data</h4>
        <h4 className="underline italic">Categories of Third Parties with Whom We Share Personal Data </h4>
        <p>
        ...
        <ul>
          ...
          <li>These are third parties that help us provide our Services, including payment processors, ad networks, security and fraud prevention providers,  hosting and other technology and communications providers, analytics providers, and staff augmentation and contract personnel.</li>
          <li>“Acquirers”</li>
          <li>These are parties who acquire your Personal Data through an acquisition or other change of control. Personal Data may be transferred to a third party if we undergo a merger, acquisition, bankruptcy or other transaction in which that third party assumes control of our business (in whole or in part).</li>
          <li>“Data Brokers”</li>
          <li>These may be ad networks or other organizations that primarily buy and sell data.</li>
          <li>“Selected Recipients”</li>
          <li>These are third parties that we share your Personal Data with at your direction, including:</li>
            <ul>
        ...
        <h4 className="underline italic">Disclosures of Personal Data for a Business Purpose</h4>
        <p>
        ...
        <ul>
          ...
          <li>Undertaking activities to verify or maintain the quality or safety of a service or device that we own, manufacture (or that was manufactured for us) or control.</li>
        </ul>
        ...
        <h4 className="underline italic">Sales of Personal Data</h4>
        ...
        <p>We sell your Personal Data to the following categories of third parties:</p>
        ...
        <h4 className="underline">Data Security and Retention</h4>
        ...
        <h4 className="underline">California Resident Rights</h4>
        ...
        <h4 className="underline italic">Deletion</h4>
        <p>
        ...
        <h4 className="underline italic">Exercising Your Rights</h4>
        <p>
        ...
        <h4 className="underline italic">Personal Data Sales Opt-Out and Opt-In</h4>
        <p>
        ...
        <p>
          You have the right to opt-out of the sale of your Personal Data. To opt out of the sale of your personal data:
        </p>

        <br />

        <ol>
          <li>Login to your RemoteReq account </li>
          <li>Go to the Preferences tab</li>
          <li>Click “Opt Out” in the section regarding the sale of your personal data</li>
        </ol>
        ...
        <h4 className="underline">Other State Law Privacy Rights</h4>
        ...
        <h4 className="underline italic">Nevada Resident Rights</h4>
        <p>
        If you are a resident of Nevada, you have the right to opt-out of the sale of certain Personal Data to third parties who intend to license or sell that Personal Data. You can exercise this right by contacting us at bryant@remotereq.com with the subject line “Nevada Do Not Sell Request” and providing us with your name and the email address associated with your account.
        </p>

        <br/>

        <h4 className="underline">Changes to this Privacy Policy</h4>
        <p>
          We’re constantly trying to improve our Services, so we may need to change this Privacy Policy from time to time, but we will alert you to any such changes by placing a notice on the RemoteReq website, by sending you an email and/or by some other means. Please note that if you’ve opted not to receive legal notice emails from us (or you haven’t provided us with your email address), those legal notices will still govern your use of the Services, and you are still responsible for reading and understanding them. If you use the Services after any changes to the Privacy Policy have been posted, that means you agree to all of the changes. Use of information we collect is subject to the Privacy Policy in effect at the time such information is collected.
        </p>
